...
const collection = () => {
  ...
  const {products,search,showSearch} = useContext(ShopContext);
    ...
    const applyFilter =()=>{
      ...
      // products in the collection page are being displayed using this
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t '>
      ...
      <div className='min-w-60'>
        ...
        {/* category filter */}
        <div className={`border border-gray-300 pl-5 mt-6 ${showFilter ? '' : 'hidden'} sm-bl`}>
        ...
        <div>
          ...
          <div className={`border border-gray-300 pl-5 my-5 ${showFilter ? '' : 'hidden'} sm-bl`}>
           ...
           <p className='flex gap-2'>
            <input className='w-3' type="checkbox"  value={'Dresses & Two Piece Outfits'} onChange={toggleSubCategory}/>Dresses & Two Piece Outfits
           </p>
           <p className='flex gap-2'>
